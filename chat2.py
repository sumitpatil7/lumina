import requests
import json
from second_prompt import ResponseEvaluator # Import the class
...
def chatbot():
    # Paths to JSON file
    json_file_path = 'Candidate_response.json'  # Replace with your actual path

    # Create an instance of InterviewQuestionGenerator
    question_generator = ResponseEvaluator(json_file_path)
    ...
    with open('candidate_results.json', 'w') as json_file:
